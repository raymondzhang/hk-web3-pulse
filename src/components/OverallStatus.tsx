...
const statusConfig: Record<StatusLevel, { color: string; bgColor: string }> = {
  Leading: { color: "text-emerald-700", bgColor: "bg-emerald-100" },
  Advancing: { color: "text-emerald-700", bgColor: "bg-emerald-100" },
  Developing: { color: "text-amber-700", bgColor: "bg-amber-100" },
  Emerging: { color: "text-slate-700", bgColor: "bg-slate-100" },
};
